...
% AUTHORS EDIT THIS PART
\title{In the Air Tonight}
\author{Phil Collins}
\altaffiliation{Manalapan High School} % use for non S&E authors
\email[Contact author: ]{420pcollins@frhsd.com} % use FRHSD address
% For S&E authors
...
\begin{abstract}
"In the Air Tonight" is a 1981 experimental pop and rock song by Phil Collins that is famous for its dark mood and massive drum break. It was released on his debut solo album, Face Value.
